...
def create_instance(user):
	...
	file.write("	comp_type=models.CharField(max_length=15,choices=complaint_type)\n")
	file.write("	status=models.CharField(max_length=15,choices=status_choices,default='Registered')\n")
